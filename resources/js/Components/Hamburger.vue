...
<template>
    <button
        id="hamburger"
        class="menu-ui rounded-lg text-gray-700 dark:text-white transition-colors ease-in-out duration-300"

        :class="{ 'is-open': isOpen, 'text-white': scrollTop > 100 }"
        @click="toggleMenu"
    >
        <svg class="transition-all ease-in-out duration-300" :class="scrollTop > 100 ? 'size-6':'size-8'" stroke="currentColor" fill="none" width="30" height="30"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
