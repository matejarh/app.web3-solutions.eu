        ...
        <section class="bg-white dark:bg-gray-900">
            <div
                ...
                <div class="mt-4 md:mt-0">
                    ...
                    <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Join us on the journey to Web3
                        and unlock a world of new possibilities for your business. Contact us today to learn more.</p>
                    <a href="#"
